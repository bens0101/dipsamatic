    ...
    <main className="activity-page">
        ...
        <Reveal animation="fade-up">
          <div className="activity-hero-content">
            ...
            <p className="activity-hero-subtitle">
              ...
              à chaque environnement : bureaux, hôtels, restaurants et espaces
              publics.
            </p>
          </div>
        </Reveal>
      ...
      <section className="activity-expertise">
        <div className="activity-inner">
          ...
          {/* Cards in 2×2 grid – wrapped ONCE in Reveal to keep alignment */}
          <Reveal animation="fade-up">
              ...
              <div className="activity-card">
                ...
                <div className="activity-card-main">
                  <div className="activity-card-text">
                    ...
                    <p>
                      Chez Dipsamatic, nous proposons des machines de
                      distribution automatique fiables et performantes,
                      conçues pour offrir une expérience de consommation
                      simple tout en respectant RSE et recyclage.
                    </p>
                  </div>
              ...
              <div className="activity-card">
                ...
                <div className="activity-card-main">
                  <div className="activity-card-text">
                    ...
                    <p>
                      Nous déployons également des solutions Office Coffee
                      System, avec des machines à café professionnelles
                      élégantes et connectées (CB), adaptées aux
              ...
              <div className="activity-card">
                ...
                <div className="activity-card-main">
                  <div className="activity-card-text">
                    ...
                    <p>
                      Dipsamatic accompagne les professionnels de l’hôtellerie
                      et de la restauration avec des machines à café
                      performantes, conçues pour répondre aux exigences de
                      qualité.
                    </p>
                  </div>
                ...
                <div className="activity-card-main">
                  <div className="activity-card-text">
                    ...
                    <p>
                      ...
                      réseau écoresponsables, offrant une eau filtrée, fraîche
                      ou tempérée, plate ou gazeuse.
                    </p>
                  </div>
